...
def main(args):
  ...
  queries = [
      ['butter', 'egg', 'onion', 'pea', 'pork', 'rice', 'soy_sauce'],
      ['duck', 'garlic', 'ginger', 'honey', 'pepper', 'salt', 'soy_sauce'],
      [
          'broth', 'carrot', 'chicken', 'garlic', 'ginger', 'green_onion',
          'peanut_sauce', 'rice', 'sesame_oil'
      ],
      [
          'baby_spinach', 'cayenne_pepper', 'clove', 'garlic', 'ginger',
          'green_onion', 'miso', 'pepper', 'salt'
      ],
      ['butter', 'chile', 'pepper'],
      ['peanut_butter', 'sesame_oil', 'soy_sauce', 'tofu', 'water'],
      [
